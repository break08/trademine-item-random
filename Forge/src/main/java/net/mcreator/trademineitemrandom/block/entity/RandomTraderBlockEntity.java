...
public class RandomTraderBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public RandomTraderBlockEntity(BlockPos position, BlockState state) {
		super(TrademineItemRandomModBlockEntities.RANDOM_TRADER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("random_trader");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RandomTraderGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
