	...
	public static void execute(Entity entity) {
		...
		if (Math.random() <= 0.8) {
			...
			if (random_receive_effects == 1) {
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, Mth.nextInt(RandomSource.create(), 7200, 9600), 0, true, true));
			}
		} else {
			if (Math.random() < 50) {
				random_receive_effects = Mth.nextInt(RandomSource.create(), 1, 7);
				if (random_receive_effects == 1) {
					...
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(MobEffects.LEVITATION, Mth.nextInt(RandomSource.create(), 140, 200), 0, false, true));
				}
			} else {
				random_receive_effects = Mth.nextInt(RandomSource.create(), 1, 3);
				if (random_receive_effects == 1) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, Mth.nextInt(RandomSource.create(), 7200, 9600), 0, false, true));
				} else if (random_receive_effects == 2) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, Mth.nextInt(RandomSource.create(), 7200, 9600), 0, false, true));
				} else if (random_receive_effects == 3) {
					if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(MobEffects.GLOWING, Mth.nextInt(RandomSource.create(), 7200, 9600), 0, false, true));
				}
			}
		}
	}
