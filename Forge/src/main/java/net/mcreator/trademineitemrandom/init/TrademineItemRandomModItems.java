...
public class TrademineItemRandomModItems {
	...
	public static final RegistryObject<Item> POTION_OF_RANDOM = REGISTRY.register("potion_of_random", PotionOfRandomItem::new);
	...
	public static final RegistryObject<Item> RAINBOW_DYE = REGISTRY.register("rainbow_dye", RainbowDyeItem::new);
	public static final RegistryObject<Item> RANDOM_SEED = REGISTRY.register("random_seed", RandomSeedItem::new);
	...
	public static final RegistryObject<Item> ANY_FOOD = REGISTRY.register("any_food", AnyFoodItem::new);
	public static final RegistryObject<Item> ANY_ARMOR_TRIM = REGISTRY.register("any_armor_trim", AnyArmorTrimItem::new);
	public static final RegistryObject<Item> ANY_MINERALS = REGISTRY.register("any_minerals", AnyMineralsItem::new);
	public static final RegistryObject<Item> SUMMONER_ARMOR_HELMET = REGISTRY.register("summoner_armor_helmet", SummonerArmorItem.Helmet::new);
