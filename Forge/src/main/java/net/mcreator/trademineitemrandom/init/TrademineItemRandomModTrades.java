...
public class TrademineItemRandomModTrades {
	...
	public static void registerWanderingTrades(WandererTradesEvent event) {
		event.getGenericTrades().add(new BasicItemListing(new ItemStack(Blocks.BIRCH_WOOD, 12),
				...
				new ItemStack(TrademineItemRandomModBlocks.ORE_OF_RANDOMNESS.get(), 5), 10, 5, 0.05f));
	}
	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (event.getType() == VillagerProfession.ARMORER) {
			...
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 4),
					...
					new ItemStack(TrademineItemRandomModItems.ANY_ARMOR_TRIM.get()), 10, 5, 0.05f));
		}
		if (event.getType() == VillagerProfession.CLERIC) {
			event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD),

					new ItemStack(TrademineItemRandomModItems.POTION_OF_RANDOM.get(), 3), 10, 5, 0.05f));
		}
		if (event.getType() == VillagerProfession.FARMER) {
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD),

					new ItemStack(TrademineItemRandomModItems.RAINBOW_DYE.get(), 3), 10, 5, 0.05f));
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 3),

					new ItemStack(TrademineItemRandomModItems.ANY_FOOD.get()), 10, 5, 0.05f));
		}
	}
}