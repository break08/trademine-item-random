...
public class RandomBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final Codec<RandomBiomeLeaveDecorator> CODEC = Codec.unit(RandomBiomeLeaveDecorator::new);
	...
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, new ResourceLocation("trademine_item_random:random_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RandomBiomeLeaveDecorator() {
		super(0.25f);
	}
